		...
		return (
			<div className="mt-[120px] h-screen">
				...
				<div className="w-full px-4 500px:px-0 500px:w-[85%] flex mx-auto">
					<div className={`w-[60px] 800px:w-[310px] h-[450px] dark:bg-slate-900  bg-white bg-opacity-90 border dark:border-none   rounded-lg shadow-lg sticky ${scroll ? "top-[120px]" : "top-[30px]"}`}>
						<SidebarProfile active={active} setActive={setActive} handleLogOut={handleLogOut} user={user} />
					</div>
