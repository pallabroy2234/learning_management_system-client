...
const CourseContent = () => {
	...
	/**
	 * @summary       React Hook Form Field Array
	 * @description   This hook is used to manage the array of course data
	 * */
	const {
								...
								<div className='dark:bg-slate-600 bg-gray-100 flex justify-center items-center rounded-md'>
									...
									<div className='mr-3'>
										{courseDataField.length > 1 && (
											<motion.button onClick={() => courseDataRemove(index)} type='button'>
									...
									<div className='flex 800px:flex-row flex-col 800px:gap-6 gap-5'>
										<div className='flex flex-col gap-2 w-full'>
											...
											<motion.input
												...
												type='text'
												placeholder='d28141d876b3470eb1577456e4b42846'
									...
									<div className='flex 800px:flex-row flex-col 800px:gap-6 gap-5'>
										<div className='flex flex-col gap-2 w-full'>
											...
											<motion.input
												...
												type='text'
												placeholder='Practice writing basic HTML structures'
										...
										<div className='flex flex-col gap-2 w-full'>
											...
											<motion.input
												...
												type='text'
												placeholder='VdoCipher, Vimeo, etc'
